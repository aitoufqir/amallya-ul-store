...
$products = [
    ...
    ['Bottines Maryam Noires', 'Bottines stylées avec presence forte.', 170, 'chaussures', 'images/pic18.png'],
    ...
    ['Jean Asma Coupe Large', 'Jean large moderne avec taille haute et tombé net.', 230, 'jeans', 'images/pic24.png'],
...
foreach ($products as $product) {
    [$nom, $description, $prix, $categorie, $image] = $product;
    $stmt->execute([$nom, $description, $prix, $categorie, $image]);
}

echo "Catalogue seeded: " . count($products) . " produits" . PHP_EOL;
